...
For another Windows computer, open the [latest GitHub release](https://github.com/ZengLLQ/lottery-app-ver.2/releases/latest) or use one of the repository files below:
